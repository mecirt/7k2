...
static void disp_slide_bar(SlideBar *slideBar, int)
{
	...
	if( w > 0 )
		vga_buffer.put_bitmap_area( slideBar->scrn_x1, slideBar->scrn_y1, bitmap0, 0, 0, w-1, hBase-1, 0, 2 );
	if( w < wBase )
		vga_buffer.put_bitmap_area( slideBar->scrn_x1, slideBar->scrn_y1, bitmap1, w, 0, wBase-1, hBase-1, 0, 2 );
}
