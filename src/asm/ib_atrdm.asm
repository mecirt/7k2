...
;
; Syntax : IMGbltAreaTransRemapDecompressHMirror( imageBuf, pitch, x, y, bitmapBuf,
...
;-------------------------------------------------
		...
		PUBLIC	IMGbltAreaTransRemapDecompressHMirror
SeekForward	PROTO	STDCALL			; see IB_ATRD.ASM

IMGbltAreaTransRemapDecompressHMirror PROC imageBuf,pitch,x,y,bitmapPtr,x1,y1,x2,y2,colorTable
...
@@clipCompress2:
		...
		ADD	EDI, pitch
		SUB	ECX, clipWidth
		SUB	EDI, ECX	; twice for word size pixel
		SUB	EDI, ECX
...
@@end:          ENDPROC
IMGbltAreaTransRemapDecompressHMirror	ENDP
