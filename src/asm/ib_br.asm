...
;----------- BEGIN OF FUNCTION IMGbltBlendRemap ------------
;
; Put an non-compressed bitmap on image buffer.
; It does not handle color key transparency but colorRemapping
;
; Syntax : IMGbltBlendRemap( imageBuf, pitch, x, y, bitmapBuf, colorTable )
;
...
;-------------------------------------------------
		...
		PUBLIC	IMGbltBlendRemap
IMGbltBlendRemap   	PROC	imageBuf, pitch, x, y, bitmapPtr, colorTable
...
@@end:          ENDPROC
IMGbltBlendRemap   	ENDP

;----------- END OF FUNCTION IMGbltBlendRemap ----------
