...
;-------------------------------------------------
		...
		PUBLIC    IMGbltWeakblendAreaRemapHMirror
IMGbltWeakblendAreaRemapHMirror	PROC   	  imageBuf, pitch, desX, desY, bitmapPtr, srcX1, srcY1, srcX2, srcY2, colorTable
...
@@end:          ENDPROC
IMGbltWeakblendAreaRemapHMirror ENDP
