...
;----------- BEGIN OF FUNCTION IMGbltHalfRemapDecompressHMirror ------
;
; Put a compressed bitmap on image buffer.
; It does handle color key transparency and remaping.
;
; Syntax : IMGbltHalfRemapDecompressHMirror( imageBuf, pitch, x, y, bitmapBuf,
;                 colorTable)
;
...
;-------------------------------------------------
		...
		PUBLIC    IMGbltHalfRemapDecompressHMirror
IMGbltHalfRemapDecompressHMirror PROC imageBuf,pitch,x,y,bitmapPtr,colorTable
...
@@transOrEffect:
		...
		JUMP_ON_FEW_TRANS_OR_EFFECT al, @@compress1a, @@nonTransWrite
@@compressed1:
...
@@end:          ENDPROC
IMGbltHalfRemapDecompressHMirror   	ENDP

;----------- END OF FUNCTION IMGbltHalfRemapDecompressHMirror ----------
