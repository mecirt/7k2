...
;----------- BEGIN OF FUNCTION IMGbltBlendRemapHMirror ------------
;
; Put an non-compressed bitmap on image buffer.
; It does not handle color key transparency but colorRemapping
;
; Syntax : IMGbltBlendRemapHMirror( imageBuf, pitch, x, y, bitmapBuf, colorTable )
;
...
;-------------------------------------------------
		...
		PUBLIC	IMGbltBlendRemapHMirror

IMGbltBlendRemapHMirror	PROC	imageBuf, pitch, x, y, bitmapPtr, colorTable
...
@@end:          ENDPROC
IMGbltBlendRemapHMirror	ENDP

;----------- END OF FUNCTION IMGbltBlendRemapHMirror ----------
