...
;----------- BEGIN OF FUNCTION IMGbltAreaRemapHMirror ------------
;
...
;
; Syntax : IMGbltAreaRemapHMirror( imageBuf, pitch, desX, desY, bitmapBuf, srcX1, srcY1, srcX2, srcY2, colorTable )
;
...
;-------------------------------------------------
		...
		PUBLIC    IMGbltAreaRemapHMirror
IMGbltAreaRemapHMirror	PROC   	  imageBuf, pitch, desX, desY, bitmapPtr, srcX1, srcY1, srcX2, srcY2, colorTable
...
@@end:          ENDPROC
IMGbltAreaRemapHMirror ENDP

;----------- END OF FUNCTION IMGbltAreaRemapHMirror ----------
