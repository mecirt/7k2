...
;----------- BEGIN OF FUNCTION IMGbltBlendAreaRemap ------------
;
...
;
; Syntax : IMGbltBlendAreaRemap( imageBuf, pitch, desX, desY, bitmapBuf, srcX1, srcY1, srcX2, srcY2, colorTable )
;
...
;-------------------------------------------------
		...
		PUBLIC    IMGbltBlendAreaRemap
IMGbltBlendAreaRemap	PROC   	  imageBuf, pitch, desX, desY, bitmapPtr, srcX1, srcY1, srcX2, srcY2, colorTable
...
@@end:          ENDPROC
IMGbltBlendAreaRemap ENDP

;----------- END OF FUNCTION IMGbltBlendAreaRemap ----------
